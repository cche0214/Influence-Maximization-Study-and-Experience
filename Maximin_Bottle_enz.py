...
if __name__ == "__main__":
    file_path = "C:\\Users\\31062\\Desktop\\Influence-Maximization-Study-and-Experience\\datasets\\graph_enz.gml"
    for k in [10, 20, 30, 40, 50]:
        print(f"\n=== 运行 k={k} ===")
        main(file_path, attribute_name="community", theta=None, k=k, verbose=1)